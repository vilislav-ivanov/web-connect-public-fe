  ...
  const { data, isLoading } = useQuery(
    ...
    },
    {
      onSuccess: (data) => {
        ...
        setFacebook(data.data.social?.facebook);
        setTwitter(data.data.social?.twitter);
        setInstagram(data.data.social?.instagram);
        setLinkedin(data.data.social?.linkedin);
        setYoutube(data.data.social?.youtube);
        setDisplaySocial(
